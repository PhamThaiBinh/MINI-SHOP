...
export const BLOG_ARTICLES: BlogArticle[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>Với diện tích hạn chế, việc nhồi nhét quá nhiều đồ đạc sẽ khiến ngôi nhà trở nên chật chội và ngột ngạt. Bằng cách áp dụng 4 giải pháp tối ưu không gian dưới đây, bạn hoàn toàn có thể biến căn hộ 35m² trở nên rộng rãi và tiện nghi bất ngờ.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <h2>1. Sự Lên Soán Của Đồ Gốm Men Mờ & Men Thủ Công</h2>
