          ...
          <div className="doppelrand-inner" style={{ padding: "28px", textAlign: "center" }}>
            ...
            <div style={{ borderRadius: "1.25rem", overflow: "hidden", border: "1px solid #cbd5e1", height: "400px", background: "#f1f5f9", position: "relative" }}>
              <iframe
                ...
                src="https://maps.google.com/maps?q=Trung+T%C3%A2m+Tin+H%E1%BB%8Dc+V%C4%83n+Ph%C3%B2ng%2C+107+d%C6%B0%E1%BB%9Dng+D5%2C+KDC+Ph%C3%BA+H%C3%B2a+1%2C+Ph%C3%BA+L%E1%BB%A3i&t=&z=17&ie=UTF8&iwloc=B&output=embed"
                width="100%"
                height="100%"
                style={{ border: 0 }}
