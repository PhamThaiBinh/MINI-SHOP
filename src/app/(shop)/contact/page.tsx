        ...
        <div className="doppelrand-outer">
          <div className="doppelrand-inner" style={{ padding: "28px", textAlign: "center" }}>
            ...
            <div style={{ marginBottom: "18px" }}>
              <a
                href={storeInfo.googleMapsUrl || "https://maps.app.goo.gl/GMg8baQSYBb1ZY8U8"}
                target="_blank"
            ...
            <div style={{ borderRadius: "1.25rem", overflow: "hidden", border: "1px solid #cbd5e1", height: "450px", background: "#f1f5f9" }}>
              <iframe
                title="Bản đồ Trung Tâm Tin Học Văn Phòng Bình Dương - 107 D5 Phú Hòa"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.683675038318!2d106.67544171125206!3d10.975150258047915!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174d17574adc65b%3A0x952b5757962451f2!2zVHJ1bmcgVMOibSBUaW4gSOG7jWMgVsSDbiBQaMOybmcgQsDrbmggRMSDxqFuZw!5e0!3m2!1svi!2s!4v1700000000000!5m2!1svi!2s"
                width="100%"
                height="100%"
                style={{ border: 0 }}
