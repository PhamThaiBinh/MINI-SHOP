...
export default function AdminProductsPage() {
  ...
  return (
    <div className="admin-wrapper">
      ...
      {/* 4. MODAL NHẬP XUẤT TỒN KHO (REDESIGNED WITH HERO DROPDOWN) */}
      {showInventoryModal && (
        <div
          style={{
            position: "fixed",
          ...
          >
            ...
            >
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
                  ...
                  >
                    {inventoryMode === "IMPORT" ? (
                      <>
                        <i className="fa-solid fa-arrow-down mr-2"></i> Lập Phiếu Nhập Kho Hàng
                      </>
                    ) : inventoryMode === "EXPORT" ? (
                      <>
                        <i className="fa-solid fa-arrow-up mr-2"></i> Lập Phiếu Xuất Kho Hàng
                      </>
                    ) : (
                      <>
                ...
                >
                  Mã Phiếu: <span style={{ background: "#ffffff", padding: "2px 8px", borderRadius: "6px", fontWeight: 900, border: "1px solid rgba(0,0,0,0.1)", letterSpacing: "0.03em" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                >
                  <History className="w-3.5 h-3.5" /> Nhật Ký Kho
                </button>
            ...
            <form onSubmit={handleSaveInventoryTransaction} style={{ padding: "24px" }}>
              {/* HERO DROPDOWN: CHỌN NGHIỆP VỤ KHO */}
              <div
                style={{
                  background: inventoryMode === "IMPORT"
                    ? "linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%)"
              ...
              >
                ...
                >
                  ...
                  Loại Nghiệp Vụ Kho (Nhập / Xuất / Kiểm Kho) *
                </label>
                <select
                  value={inventoryMode}
                  onChange={(e) => {
                  ...
                  style={{
                    ...
                    fontFamily: "'Plus Jakarta Sans', sans-serif",
                    background: "#ffffff",
                    color: inventoryMode === "IMPORT" ? "#15803d" : inventoryMode === "EXPORT" ? "#b91c1c" : "#b45309",
                    cursor: "pointer",
                    boxShadow: "0 4px 12px rgba(0,0,0,0.05)",
                    outline: "none",
                  }}
                >
                  <option value="IMPORT">📥 1. Nhập Kho — Tiếp nhận & nhập hàng từ xưởng/nhà cung cấp (Tăng tồn kho)</option>
                  <option value="EXPORT">📤 2. Xuất Kho — Xuất hàng bán sỉ, trưng bày showroom, điều chuyển (Giảm tồn kho)</option>
                  <option value="AUDIT">📋 3. Kiểm Kho — Kiểm kê số lượng thực tế & cân bằng sai lệch sổ sách</option>
                </select>
              </div>

              {/* PRODUCT SELECTION CARD WITH THUMBNAIL & CODE */}
              <div style={{ marginBottom: "20px", position: "relative" }}>
                <label style={{ fontSize: "13px", fontWeight: 800, color: "#1e293b", display: "block", marginBottom: "6px", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  Sản Phẩm Cần {inventoryMode === "IMPORT" ? "Nhập Kho" : inventoryMode === "EXPORT" ? "Xuất Kho" : "Kiểm Kho"} *
                </label>
                ...
                >
                  {(() => {
                    ...
                    if (!sel) return <span style={{ color: "#94a3b8", fontSize: "13.5px" }}>Chọn sản phẩm...</span>;
                    return (
                      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                        <img
                          src={fixImagePath(sel.image)}
                          alt={sel.name}
                          style={{ width: "38px", height: "38px", borderRadius: "8px", objectFit: "cover", border: "1px solid #e2e8f0" }}
                        />
                        <div>
                          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                            <code style={{ background: "#f1f5f9", padding: "2px 6px", borderRadius: "4px", color: "#1e293b", fontSize: "11.5px", fontWeight: 800 }}>
                              P{String(sel.id).padStart(4, "0")}
                            </code>
                            <strong style={{ fontSize: "13.5px", color: "#0f172a" }}>{sel.name}</strong>
                          </div>
                          <div style={{ fontSize: "12px", color: "#64748b", marginTop: "2px" }}>
                            Danh mục: <strong>{sel.categoryName || sel.category}</strong> • Tồn kho hiện tại:{" "}
                            <span style={{ color: (sel.stock !== undefined ? sel.stock : 15) <= 10 ? "#b45309" : "#166534", fontWeight: 800 }}>
                              {sel.stock !== undefined ? sel.stock : 15} món
                            </span>
                          </div>
                        </div>
                      </div>
                          ...
                          return (
                            ...
                            >
                              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                                ...
                                />
                                <div>
                                  <span style={{ fontSize: "13px", fontWeight: isSelected ? 800 : 700, color: isSelected ? "#166534" : "#1e293b" }}>
                                    <code style={{ background: "#f1f5f9", padding: "2px 5px", borderRadius: "4px", marginRight: "6px", fontSize: "11px" }}>
                              ...
                              <span style={{ fontSize: "12px", color: "#64748b", fontWeight: 700 }}>
                                Tồn: <strong>{p.stock !== undefined ? p.stock : 15}</strong>
                              </span>
                            </div>
                          );
                        })}
              ...
              {/* QUANTITY & LIVE STOCK CALCULATION WIDGET */}
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1.25fr", gap: "16px", marginBottom: "20px" }}>
                <div>
                  <label style={{ fontSize: "13px", fontWeight: 800, color: "#1e293b", display: "block", marginBottom: "6px", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                    {inventoryMode === "IMPORT"
                      ? "Số Lượng Nhập Thêm (Món)"
                      : inventoryMode === "EXPORT"
                      ? "Số Lượng Xuất Đi (Món)"
                      : "Số Lượng Đếm Thực Tế Tại Kho (Món)"} *
                  </label>
                  <input
                    type="number"
                    min="0"
                  ...
                  <div style={{ display: "flex", gap: "6px", marginTop: "8px", flexWrap: "wrap" }}>
                    {(inventoryMode === "EXPORT" ? ["5", "10", "20", "50"] : ["5", "10", "20", "50", "100"]).map((num) => (
                      <button
                        key={num}
                        type="button"
                        ...
                        style={{
                          ...
                          borderRadius: "8px",
                          border: "1px solid #cbd5e1",
                          background: inventoryQty === num ? (inventoryMode === "IMPORT" ? "#166534" : inventoryMode === "EXPORT" ? "#991b1b" : "#b45309") : "#f8fafc",
                ...
                {(() => {
                  ...
                  return (
                    <div
                      style={{
                        background: inventoryMode === "AUDIT" && discrepancy !== 0
                          ? "#fffbeb"
                          : inventoryMode === "IMPORT"
                          ? "#f0fdf4"
                          : inventoryMode === "EXPORT" && qtyVal > currentS
                          ? "#fef2f2"
                          : "#f8fafc",
                        border: inventoryMode === "AUDIT" && discrepancy !== 0
                          ? "1.5px solid #fde68a"
                          : inventoryMode === "IMPORT"
                          ? "1.5px solid #bbf7d0"
                          : inventoryMode === "EXPORT" && qtyVal > currentS
                    ...
                    >
                      <div style={{ fontSize: "11px", fontWeight: 800, color: "#64748b", textTransform: "uppercase", marginBottom: "4px" }}>
                        {inventoryMode === "AUDIT" ? "Đối Soát Kiểm Kê Hệ Thống" : "Biến Động Tồn Kho Thực Tế"}
                      </div>
                      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                        <span style={{ fontSize: "14px", fontWeight: 700, color: "#64748b" }}>Hiện tại: <strong>{currentS}</strong></span>
                        <span style={{ fontSize: "14px", color: "#94a3b8" }}>➔</span>
                        <span
                          style={{
                            fontSize: "20px",
                            fontWeight: 900,
                            color: inventoryMode === "IMPORT" ? "#166534" : inventoryMode === "EXPORT" ? (calcNewS <= 5 ? "#dc2626" : "#0f172a") : "#b45309",
                          }}
                        >
                      ...
                      {inventoryMode === "AUDIT" ? (
                        <div style={{ fontSize: "11.5px", fontWeight: 800, color: discrepancy === 0 ? "#166534" : discrepancy < 0 ? "#dc2626" : "#d97706", marginTop: "6px" }}>
                          {discrepancy === 0
                        ...
                        <div style={{ fontSize: "11.5px", fontWeight: 800, color: inventoryMode === "IMPORT" ? "#166534" : qtyVal > currentS ? "#dc2626" : "#475569", marginTop: "6px" }}>
                          {inventoryMode === "IMPORT"
                            ? `Nhập thêm: +${qtyVal} món`
                            : qtyVal > currentS
                            ? `Cảnh báo: Xuất vượt quá tồn kho (${qtyVal} > ${currentS})`
                            : `Xuất giảm: -${qtyVal} món`}
                        </div>
                      )}
                    </div>
                  );
              ...
              <div style={{ marginBottom: "18px" }}>
                <label style={{ fontSize: "13px", fontWeight: 800, color: "#1e293b", display: "block", marginBottom: "6px", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  {inventoryMode === "IMPORT"
                    ...
                    : inventoryMode === "EXPORT"
                    ? "Nơi Nhận / Showroom Xuất Đến"
                    : "Đơn Vị / Cá Nhân Thực Hiện Kiểm Kho"}
                </label>
                <input
                  type="text"
                  className="form-control admin-setting-input"
                  placeholder={
                    inventoryMode === "IMPORT"
                      ? "Ví dụ: Tổng Kho Gỗ An Cường / Xưởng Đồng Nai"
                      : inventoryMode === "EXPORT"
                      ? "Ví dụ: Showroom Quận 1 / Kho Hàng Trưng Bày"
                      : "Ví dụ: Ban Kiểm Kê Nội Bộ Kho"
                  }
              ...
              <div style={{ marginBottom: "24px" }}>
                ...
                <textarea
                  ...
                  placeholder={
                    inventoryMode === "IMPORT"
                      ? "Nhập ghi chú đợt hàng, số hóa đơn chứng từ..."
                      : inventoryMode === "EXPORT"
                      ? "Ghi chú mục đích xuất, người nhận hàng..."
                      : "Ghi chú biên bản kiểm kê, hướng xử lý..."
                  }
